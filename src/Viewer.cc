...
Viewer::Viewer(SystemPtr  pSystem, FrameDrawerPtr pFrameDrawer, MapDrawerPtr pMapDrawer, TrackingPtr pTracking, const string &strSettingPath):
...
void Viewer::Run()
{
    ...
    pangolin::CreateWindowAndBind("ORB-SLAM2-DualCam: Map Viewer",1280,640);
    ...
    while(true)
    {
        ...
        mpMapDrawer->GetCurrentRelocOpenGLCameraMatrix(TwcRelc);
        ...
        glClearColor(0.91f,0.827f,0.819f,1.0f);
        mpMapDrawer->DrawCurrentCamera();
        mpMapDrawer->DrawRelocCamera(TwcRelc);
