...
###ORB-SLAM2-DualCam version 1.0

In this document we list all the pieces of code included  by ORB-SLAM2-DualCam and linked libraries which are not property of the authors of ORB-SLAM2.
